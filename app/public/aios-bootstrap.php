...
if (file_exists('C:/Personal programs/Local/resources/extraResources/local-bootstrap.php')) {
	include_once('C:/Personal programs/Local/resources/extraResources/local-bootstrap.php');
}
$GLOBALS['aiowps_firewall_rules_path'] = __DIR__.'/wp-content/uploads/aios/firewall-rules/';

$GLOBALS['aiowps_firewall_data'] = array(
	'ABSPATH' => 'C:/Users/pocat/Local Sites/lingopoke/app/public/',
);
